...
import { SelectedProvidersPanel } from "./components/SelectedProvidersPanel";
  ...
  return (
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-[1800px] mx-auto space-y-3">
        ...
        {/* Selected Providers Panel - Always visible at App level */}
        <SelectedProvidersPanel
          selectedProviders={selectedProviders}
          onClearSelections={clearProviderSelections}
          onRemoveProvider={toggleProviderSelection}
          onNavigateToAnalysis={() => setActiveTab("opportunities")}
        />
      </div>
    </div>
  );
