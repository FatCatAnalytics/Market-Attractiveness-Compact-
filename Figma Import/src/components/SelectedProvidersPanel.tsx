...
export function SelectedProvidersPanel({
  ...
  return (
    <Card className="fixed bottom-6 right-6 p-4 shadow-2xl border-2 border-primary/20 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/90 dark:to-indigo-950/90 backdrop-blur-sm max-w-md z-50">
